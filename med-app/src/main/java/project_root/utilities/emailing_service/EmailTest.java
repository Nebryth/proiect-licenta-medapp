package project_root.utilities.emailing_service;
...
public class EmailTest {
    ...
    public static void main(String[] args) {
        ...
        StringTemplateGroup group = new StringTemplateGroup("myGroup", "D:\\proiect-licenta-medapp\\med-app\\src\\main\\java\\proj.utilities\\emailing_service\\resources", DefaultTemplateLexer.class);
